...
<template>
  <footer class="bg-green-500 text-white py-10 mt-12">
    ...
    >
      ...
      <div
        class="flex flex-col md:flex-row md:items-center md:space-x-1 flex-1 min-w-[250px]"
      >
        <!-- Logo -->
        <img
          src="/logo-man.png"
        ...
        <div class="mt-4 md:mt-0 text-center md:text-left">
          ...
          <p class="text-sm mt-2">
            Jl. Majapahit, Pringgolayan, Pranti, Kec. Banguntapan, Kabupaten
            Bantul, Daerah Istimewa Yogyakarta | Telp (0274) 452168
          </p>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 flex-1 min-w-[250px]">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <router-link
                to="/profil/latar-belakang"
                class="hover:text-yellow-300"
                >Latar Belakang</router-link
              >
            </li>
            <li>
              <router-link to="/profil/visi-misi" class="hover:text-yellow-300"
                >Visi & Misi</router-link
              >
            </li>
            <li>
              <router-link
                to="/profil/struktur_organisasi"
                class="hover:text-yellow-300"
